...
<body>
	<div class="container">
		<table id="dg" style="width:100%;height:470px" title="操作员信息"
			data-options="
                rownumbers:true,
                remoteSort:true,
                singleSelect:true,
		...
		<div id="tb" style="padding:0 30px;">
			<div class="conditions">
				<a style="margin-left: 2%" href="javascript:openAdd();"
					...
					class="con-span" style="margin-left: 50%">操作员名字: </span><input
		...
		<form id="wu-form-2" method="post">
			<table style="border-collapse:separate; border-spacing:10px;">
				...
				<tr>
					...
					<td><input type="text" name="tel" class="wu-text"
						required="required" /></td>
				</tr>
				<tr>
					<td align="right">密码:</td>
					<td><input type="password" name="pass" class="wu-text"
						required="required" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="idcard" class="wu-text"
						required="required" /></td>
				</tr>
				<tr>
					...
					<td><input class="easyui-combobox wu-text" name="status"
						...
						data-options="valueField:0,textField:1,url:'../operator/statuslist'"></td>
				</tr>
			</table>
		</form>
	</div>
