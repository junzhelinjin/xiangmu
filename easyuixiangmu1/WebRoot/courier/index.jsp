...
<body>
	<div class="container">
		<table id="dg" style="width:100%;height:470px" title="配送员信息"
			data-options="
                rownumbers:true,
                remoteSort:true,
                singleSelect:true,
		...
		<div id="tb" style="padding:0 30px;">
			<div class="conditions">
				<a style="margin-left: 2%" href="javascript:openAdd();"
					...
					class="con-span" style="margin-left: 50%">配送员名字: </span><input
			...
			<table style="border-collapse:separate; border-spacing:10px;">
				...
				<tr>
					...
					<td><input class="easyui-combobox wu-text" name="status"
						...
						data-options="valueField:0,textField:1,url:'../courier/statuslist'"></td>
				</tr>
			</table>
		</form>
	</div>
