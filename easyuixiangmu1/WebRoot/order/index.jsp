		...
		<div id="tb" style="padding:0 30px;">
			<div class="conditions">
				<a style="margin-left: 2%" href="javascript:openAdd();"
					...
					class="con-span" style="margin-left: 50%">配送员名字: </span>
					<input
					class="easyui-textbox" id="txt" type="text" name="id"
		...
		<form id="wu-form-2" method="post">
			<table style="border-collapse:separate; border-spacing:10px;">
				...
				<tr>
					...
					<td><input class="easyui-combobox wu-text" name="operator_id"
						editable="false" required="required"
						data-options="valueField:'id',textField:'name',url:'../order/operatorlist'"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input class="easyui-combobox wu-text" name="courier_id"
						editable="false" required="required"
						data-options="valueField:'id',textField:'name',url:'../order/courierlist'"></td>
				</tr>
		...
		<form id="wu-form-3" method="post">
			<table style="border-collapse:separate; border-spacing:10px;">
				...
				<tr>
					...
					<td><input  type="text" name="enterdate" class="easyui-datebox wu-text" required="required"></td>
				</tr>
				<tr>
					<td align="right">操作人:</td>
					<td><input class="easyui-combobox wu-text" name="operator_id"
