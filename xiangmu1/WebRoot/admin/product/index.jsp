...
<script type="text/javascript">
	...
	function openNewWin(title, url) {
		showPage(title,url,520,500,fun,true);
		
	}
	function openNewWin1(title, url) {
		showPage(title,url,520,400,fun);
	}
</script>
</head>
<body>
						...
						<div style="float: right;">
							<form action="product/index" method="post">
								<input type="hidden" name="math" value="like"> <input
									type="hidden" name="table" value="product"> 
										...
										<tr>
											...
											<td>
												<div
													...
													<a class="blue"
														href="javascript:openNewWin('新增','product/add');"> <i
														class="icon-zoom-in bigger-130"></i>
													</a> <a class="green"
														href="javascript:openNewWin1('修改','product/edit?id=${r.id}');">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="dataTables_paginate paging_bootstrap">
									<a href="product/index?pageno=${requestScope.where.prepage}">上一页</a>&nbsp;&nbsp;&nbsp;<a href="product/index?pageno=${requestScope.where.nextpage}">下一页</a>
								</div>
							</div>
						</div>
					</div>
