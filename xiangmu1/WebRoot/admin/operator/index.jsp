...
<script type="text/javascript">
	...
	function openNewWin(title, url) {
		showPage(title,url,540,350,fun,true);
	}
	function openNewWin1(title, url) {
		showPage(title,url,340,380,fun);
	}
</script>
</head>
<body>
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div style="float: right;">
							<form action="operator/index" method="post">
								<input type="hidden" name="math" value="like"> <input
									type="hidden" name="table" value="operator"> <input
									type="hidden" name="col" value="name"> 
									<input name="value" placeholder="根据名字查询" value="${requestScope.value}"> &nbsp; <input
										...
										<tr>
											...
											<td>
												<div
													...
													<a class="blue"
														href="javascript:openNewWin('新增','operator/add');" id="aa"> <i
														class="icon-zoom-in bigger-130"></i>
													</a> <a class="green"
														href="javascript:openNewWin1('修改','operator/edit?id=${r.id}');">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="dataTables_paginate paging_bootstrap">
									<a href="operator/index?pageno=${requestScope.where.prepage}">上一页</a>&nbsp;&nbsp;&nbsp;<a href="operator/index?pageno=${requestScope.where.nextpage}">下一页</a>
								</div>
							</div>
						</div>
					</div>
